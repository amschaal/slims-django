...
class Run(models.Model):
    ...
    unique_id = models.CharField(max_length=50, null=True, blank=True, unique=True)
    description = models.TextField(blank=True, null=True)
...
class LaneData(models.Model):
    ...
    data_id = models.SlugField(null=True) #Used to keep track of which autogenerated data path it is
